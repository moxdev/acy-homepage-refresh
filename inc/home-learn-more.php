      ...
      <div class="home-sub-content-wrapper col-<?php echo $count; ?>">
        <?php while ( have_rows('home_page_sub_content') ) : the_row();
          ...
          <div class="home-sub-content-inner-wrapper">
            <img src="<?php echo esc_url( $sub_content_img['sizes']['learn-more-feature-image'] ); ?>" alt="<?php echo esc_attr( $sub_content_img['alt'] ); ?>" description="<?php echo esc_attr( $sub_content_img['description'] ); ?>">
