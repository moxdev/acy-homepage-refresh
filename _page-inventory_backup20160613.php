						...
						<div class="boatFacetSection">
							<label for="boatClass">Boat Class
								<select name="Class" class="boatFacet" id="boatClass">
								    ...
								    <option value="Antique and Classics">Antique and Classics</option>
								    <option value="Bowrider">Bowrider</option>
								    <option value="Catamaran">Catamaran</option>
								    <option value="Center Cockpit">Center Cockpit</option>
								    <option value="Center Consoles">Center Consoles</option>
								    <option value="Convertible Boats">Convertible Boats</option>
								    ...
								    <option value="Deck Boats">Deck Boats</option>
								    ...
								    <option value="Ski and Fish">Ski and Fish</option>
								    <option value="Sloop">Sloop</option>
								    <option value="Sports Cruiser">Sports Cruiser</option>
								    <option value="Sports Fishing Boats">Sports Fishing Boats</option>
